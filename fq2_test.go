...
func TestFQ2RandomFrobenius(t *testing.T) {
	x := NewXORShift(2)
...
func TestFQ2RandomMultiplication(t *testing.T) {
	x := NewXORShift(3)
...
func TestFQ2RandomAddition(t *testing.T) {
	x := NewXORShift(3)
...
func TestFQ2RandomSubtraction(t *testing.T) {
	x := NewXORShift(3)
...
func TestFQ2RandomNegation(t *testing.T) {
	x := NewXORShift(3)
...
func TestFQ2RandomDoubling(t *testing.T) {
	x := NewXORShift(3)
...
func TestFQ2RandomSquaring(t *testing.T) {
	x := NewXORShift(3)
...
func TestFQ2RandomInversion(t *testing.T) {
	x := NewXORShift(3)
	...
	for i := 0; i < 10000; i++ {
		...
		if !a.Equals(bls.FQ2One) {
			t.Fatal("expected a * a^-1 = 1")
		}
	}
}

func TestFQ2RandomExpansion(t *testing.T) {
	x := NewXORShift(3)
